...
app.use(express.static(path.resolve(__dirname, "..", "examples-networked")));

// Start Express http server
const webServer = http.createServer(app);
const socketIo = new Server(webServer);
// To enable https on the node server, comment the line above and uncomment the line below
// const webServer = https.createServer(credentials, app);

// Start Socket.io so it attaches itself to Express server
const socketServer = socketIo.listen(18080, { "log level": 1 });
const myIceServers = [
