...
const error = debug('device:error');
 ...
 */
export const isWebXRAvailable = (typeof window !== 'undefined' && window.navigator.xr !== undefined);
...
if (isWebXRAvailable) {
  ...
  if (typeof window !== 'undefined' && window.navigator.getVRDisplays) {
