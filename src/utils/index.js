...
export * as forceCanvasResizeSafariMobile from './forceCanvasResizeSafariMobile';
export * as material from './material';
export { split } from './split';
export * as styleParser from './styleParser';
export * as trackedControls from './tracked-controls';
 ...
 */
export function extendDeep(o, ...args) {
  for (const a of args) {
    o = { ...o, ...structuredClone(a) };
  }
  return o;
}
...
export * as srcLoader from './src-loader';
