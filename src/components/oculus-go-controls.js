...
const GAMEPAD_ID_WEBXR = 'oculus-go';
const GAMEPAD_ID_WEBVR = 'Oculus Go';
const OCULUS_GO_CONTROLLER_MODEL_URL = AFRAME_CDN_ROOT + 'controllers/oculus/go/oculus-go-controller.gltf';
