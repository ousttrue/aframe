...
const isValidDefaultValue = PropertyTypes.isValidDefaultValue;
const propertyTypes = PropertyTypes.propertyTypes;

const warn = debug('core:schema:warn');
 ...
 */
export const parseProperties = (function() {
  var propNames = [];
